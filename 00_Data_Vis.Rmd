...
## CQ, Temp, Cond
```{r}
# plain plots for conductivity, temperature, and discharge (change the x variable and limits)
...
outCQPlot <- ggplot(
  ...
  theme_bw() +
  geom_line() +
  lims(x = c(212, 244), y = c(100, 750))+
  labs(x="Date",y = "Cumulative Discharge (cms)")+
  scale_x_continuous(breaks=labels_x,labels=c("30-Apr","05-May","10-May","15-May","20-May", "25-May","30-May","4-Jun","9-Jun","14-Jun"),limits=c(212,244))
...
buoyPlot <- ggplot(
  ...
  theme_classic()+
  geom_vline(xintercept=as_datetime("2018-05-22 01:39:00"),color="purple")+ # obs ice-off
  geom_vline(xintercept=as_datetime("2018-05-21 01:39:00"),color="red")+ # pierson ice-off
