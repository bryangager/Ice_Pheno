...
ggplot(
  ...
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2014], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0,50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)", title="2014")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2015),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2015], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 60), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)", title="2015")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2016),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2016], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 50), y = c(0, 5))+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2017),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2017], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 60), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2018),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2018], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2019),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2019], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0,50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2020),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2020], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 40), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2021),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2021], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 40), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2022),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2022], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2023),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = obs_ice_on_dates$wy_doy_ice_on[obs_ice_on_dates$waterYear == 2023], color="forestgreen", size=1.5)+ # observed ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(0, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
