...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2014),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2014], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2014], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2015),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2015], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2015], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(10, 60), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2016),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2016], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2016], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(40, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2017),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2017], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2017], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(30, 60), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2018),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2018], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2018], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(20, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2019),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2019], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2019], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(30, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2020),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2020], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2020], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(20, 40), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
  theme(panel.ontop=TRUE,panel.background = element_rect(fill = NA))
```
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2021),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2021], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2021], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(20, 40), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2022),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2022], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2022], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(30, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2023),
  aes(x = wy_doy, y = Flow, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2023], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2023], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(30, 50), y = c(0, 5))+
  labs(x = "Date", y = "Flow (cfs)")+
...
ggplot(
  daily_data_trimmed_winter %>%
    filter(waterYear == 2014),
  aes(x = wy_doy, y = cond_uScm, group = waterYear)) +
  geom_vline(xintercept = ice_on_dates$first_ice_presence_doy[ice_on_dates$waterYear == 2014], color="forestgreen", size=1.5)+ # observed ice-on date
  geom_vline(xintercept = ice_on_dates$first_ice_predicted_doy[ice_on_dates$waterYear == 2014], color="orange", size=1.5)+ # hindcasted ice-on date
  theme_dark() +
  geom_line() +
  lims(x = c(10, 50), y = c(20, 30))+
