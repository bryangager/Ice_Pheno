...
labels_x<-c(120,160,200,240,280)
...
ggplot(
  ...
  theme_bw() +
  geom_line() +
  lims(x = c(124, 290), y = c(-3, 40))+
  labs(x = "Date", y = "Conductivity (uS/cm)")+
  scale_x_continuous(breaks=labels_x,labels=c("28-Jan","09-Mar","18-Apr","28-May","07-Jul"),limits=c(124,290))
```
