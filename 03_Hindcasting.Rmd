...
ggplot() +   
  ...
  geom_errorbar(data = obs_ice_off_dates, aes(x = waterYear,y = wy_doy_ice_off,ymin = wy_doy_ice_off - 7,ymax = wy_doy_ice_off+7),width = .1,position = position_dodge(0.05))+
