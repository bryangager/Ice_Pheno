...
preds_ice_on <- predict(rollingAirTempCond_model,
  newdata = select(met_hydro_winter, -ice_presence), # remove real outcomes
  type = "response"
)
...
accuracy_05 <- sum(diag(tab_ice_on)) / sum(tab_ice_on)
accuracy_05

# sensitivity
sensitivity_05 <- tab_ice_on[2, 2] / (tab_ice_on[2, 2] + tab_ice_on[2, 1])
sensitivity_05

# specificity
specificity_05<- tab_ice_on[1, 1] / (tab_ice_on[1, 1] + tab_ice_on[1, 2])
specificity_05
```
#Plots
## Daily Air Temp
